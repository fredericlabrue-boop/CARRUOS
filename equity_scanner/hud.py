...
def radar() -> str:
    ...
    return (
        ...
        + "".join(f'<circle cx="66" cy="66" r="{r}" fill="none" '
                  f'stroke="rgba(34,211,238,.16)" stroke-width=".7"/>'
                  for r in (20, 36, 52))
        + '<circle cx="66" cy="66" r="60" fill="none" '
          'stroke="rgba(34,211,238,.3)" stroke-width="1" '
          'stroke-dasharray="3 6"/>'
          '<line x1="6" y1="66" x2="126" y2="66" stroke="rgba(34,211,238,.1)"/>'
          '<line x1="66" y1="6" x2="66" y2="126" stroke="rgba(34,211,238,.1)"/>'
...
def fond(trace: str) -> str:
    ...
    anneaux = (
        ...
        '<circle class="rot3" cx="125" cy="125" r="119" fill="none" '
        'stroke="rgba(34,211,238,.3)" stroke-width="1" vector-effect="non-scaling-stroke"/>'
        '<circle class="rot1" cx="125" cy="125" r="110" fill="none" '
        'stroke="rgba(34,211,238,.55)" stroke-width="1.2" vector-effect="non-scaling-stroke" stroke-dasharray="2 9"/>'
        '<circle class="rot2" cx="125" cy="125" r="100" fill="none" '
        'stroke="rgba(80,230,255,.72)" stroke-width="1.4" vector-effect="non-scaling-stroke" '
        'stroke-dasharray="42 26 8 26"/>'
        '<circle class="rot1" cx="125" cy="125" r="90" fill="none" '
        'stroke="rgba(34,211,238,.26)" stroke-width="3.5" vector-effect="non-scaling-stroke" stroke-dasharray="1 15"/>'
        '<circle class="rot3" cx="125" cy="125" r="77" fill="none" '
        'stroke="rgba(34,211,238,.36)" stroke-width="1" vector-effect="non-scaling-stroke" '
